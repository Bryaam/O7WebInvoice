namespace Angkor.O7Web.Common.Finantial.Entity
{
    public class AddressFact
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="T:System.Object" /> class.</summary>
        public AddressFact(string address, string codPostal, string department, string province, string district, string city, string country, string zone, string route, string phone, string fax, string contact)
        {
            Address = address;
            CodPostal = codPostal;
            Department = department;
